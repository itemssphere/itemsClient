...
import styles from "./OrganizationPrograms.module.css";

const OrganizationPrograms = ({ mainPage, withDonate, data }) => {
  return (
    <div
      className={
        mainPage
          ? styles["social-programs-container"]
          : styles["social-program-shop"]
      }
    >
      <div className={styles["social-program-item-container"]}>
        <div
          className={`${styles["social-program-item-image"]} ${!mainPage && styles["social-program-image"]}`}
          style={{ backgroundImage: `url('${data.cover}')` }}
        ></div>
        <div className={styles["social-program-description"]}>
          <p className="bold fs14" style={{ marginBottom: "18px", height: "28px" }}>
            {data.title}
          </p>
          <div className={styles["social-programs-actions"]}>
            ...
            >
              ...
              <p className={`${styles["social-programs-favorited-quantity"]}`}>
                {data.likes_count}
              </p>
          ...
          {withDonate && (
            <div className={styles["donation-container"]}>
              <div className={styles["donation-input-container"]}>
                <input className={styles["donation-input"]} />
                <span>₾</span>
              </div>
