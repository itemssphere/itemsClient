...
import styles from "./SocialProject.module.css";

const SocialProjectItem = ({
    socialProgramsPage,
  organizationsPage,
}) => {
  return (
    <div className={organizationsPage && styles["social-projects-container-orgs"]}>
      <div
        className={`${styles["social-programs-container"]} ${
          socialProgramsPage ? styles["social-programs-page-item"] : ""
        }`}
        style={{ marginBottom: socialProgramsPage ? "20px" : "0px", marginRight: organizationsPage ? "0px" : "10px" }}
      >
        <div className={styles["social-program-item-container"]}>
          <div
            className={`${styles["social-program-item-image"]} ${
              socialProgramsPage
                ? styles["social-programs-page-item-image"]
                : ""
            }`}
          ...
          >
            <p className="bold fs14">Justice for Jake Blake</p>
            <div className={styles["social-programs-wrapper"]}>
              <p
                className={`fs13 ${
                  socialProgramsPage
                    ? styles["social-program-item-description"]
                    : ""
                } ${styles["social-programs-paragraph"]}`}
              >
            ...
            >
              <p className="fs13">
                ...
                <span style={{ color: "#575757" }}>raised of 25,000₾ Goal</span>
              </p>
            </div>
          ...
          <div className={styles["left-side"]}>
            <div style={{ display: "flex" }}>
              <span
                ...
                style={{ color: "#707070", opacity: "0.7", width: "66px" }}
              >
                Created:{" "}
              </span>
              <span
...
export default SocialProjectItem;
