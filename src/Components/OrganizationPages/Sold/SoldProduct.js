      ...
      <div className={styles["sold-item-container"]}>
        ...
        >
          ...
          >
            ...
            />
            <div>
              <p className={`${styles["color-gray"]} fs20`}>
                Irakli Mazmishvili
              </p>
              <p className={`${styles["color-gray"]} fs13`}>
        ...
        <div className={styles["order-details-buttons"]}>
          ...
          <button className={styles["order-detail-collapse"]} onClick={() => setShowDetailed(!showDetailed)}>Collapse</button>
        </div>
        {showDetailed && <div className={styles["order-details-form"]}>
          <div className={styles["order-details-input-forms"]}>
            ...
            <div className={styles["form-input-container"]}>
              <label className={styles["organization-label"]}>Personal #</label>
              <input
                type="email"
                name="search"
                className={styles["form-control-orgs"]}
