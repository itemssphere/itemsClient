...
import AddNewDropdown from "../AddNew/AddNewDropdown";
...
const Header = ({type}) => {
  ...
  return (
    <>
      {openSignInModal && <SignIn closeModal={closeSignInModal} showForgotPass={setShowForgotPassword} showRegistration={setShowRegistrationModal} />}
      {showForgotPassword && <ForgotPassword closeModal={closeForgotPasswordModal} showRegistration={setShowRegistrationModal} />}
      {showRegistrationModal && <Registration closeModal={closeRegistrationModal} showSignIn={setOpenSignInModal} />}
      {showTopBanner && (
      ...
      <div className={`container ${styles["desktop-header"]}`}>
        <header className={styles["header-container"]}>
          ...
          <div className={styles["header-right-side"]}>
            <UsersDropdown showSignIn={setOpenSignInModal} showRegistration={setShowRegistrationModal} />
            <AddNewDropdown />
            <Messages />
            <Notifications />
            <Favorites />
      ...
      <div className={`${styles["header-mobile"]} ${styles["mobile-view"]}`}>
        <NavLink
          activeClassName={styles["active-navbar"]}
          to="/"
          exact
          className={`${styles["header-mobile-item"]} ${styles["mobile-header-home"]}`}
        >
          <div className={styles["header-mobile-items-block"]}>
            <svg
          ...
          <p className={styles["header-mobile-item-title"]}>Home</p>
        </NavLink>
        ...
        <NavLink
          ...
          to="/market"
          exact
          className={`${styles["header-mobile-item"]} ${styles["mobile-header-market"]}`}
        >
          <div className={styles["header-mobile-items-block"]}>
            <svg
              id="layout-grid-line"
          ...
          <p className={styles["header-mobile-item-title"]}>Market</p>
        </NavLink>
        <div className={styles["vr-line"]}></div>
        <NavLink
          activeClassName={styles["active-navbar"]}
          to="/shops"
          exact
          className={`${styles["header-mobile-item"]} ${styles["mobile-header-shop"]}`}
        >
          <div className={styles["header-mobile-items-block"]}>
            <svg
              id="store-line"
          ...
          <p className={styles["header-mobile-item-title"]}>Shop</p>
        </NavLink>
        <div className={styles["vr-line"]}></div>
        <NavLink
          activeClassName={styles["active-navbar"]}
          to="/charities"
          exact
          className={`${styles["header-mobile-item"]} ${styles["mobile-header-social-one"]}`}
        >
          <div className={styles["header-mobile-items-block"]}>
            <svg
              id="service-line"
          ...
          <p className={styles["header-mobile-item-title"]}>Charities & NPOs</p>
        </NavLink>
        <div className={styles["vr-line"]}></div>
        <NavLink
          activeClassName={styles["active-navbar"]}
          to="/social-programs"
          exact
          className={`${styles["header-mobile-item"]} ${styles["mobile-header-social"]}`}
        >
          <div className={styles["header-mobile-items-block"]}>
            <svg
              id="hand-heart-line"
          ...
          <p className={styles["header-mobile-item-title"]}>Social Programs</p>
        </NavLink>
        <div className={styles["vr-line"]}></div>
        <NavLink
          activeClassName={styles["active-navbar"]}
          to="/news"
          exact
          className={`${styles["header-mobile-item"]} ${styles["mobile-header-news"]}`}
        >
          <div className={styles["header-mobile-items-block"]}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <p className={styles["header-mobile-item-title"]}>News</p>
        </NavLink>
      </div>
      <MobileHead type={type} />
    </>
  );
};
